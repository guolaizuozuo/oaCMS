package com.tc51.oacms.common.aspect;
...
public class ControllerEndpointAspect extends AspectSupport {
    ...
    @Pointcut("@annotation(com.tc51.oacms.common.annotation.ControllerEndpoint)")
    ...
    public Object saveSysLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        sysLog.setParams("paramName:"+ Arrays.toString(paramNames) +",args:"+ JSON.toJSONString(args));
       ...
       sysLog.setLocation(AddressUtil.getCityInfo(ipAddr));
        ...
        sysLog.setUsername(activeUser.getUser().getName());
        //添加时间
